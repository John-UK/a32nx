...
export class PFDSimvarPublisher extends SimVarPublisher<PFDSimvars> {
    private static simvars = new Map<keyof PFDSimvars, SimVarDefinition>([
        ...
        [
            ...
            {
                name: PFDVars.potentiometerCaptain,
                type: SimVarValueType.Number,
            },
        ],
        [
            "potentiometerFo",
            { name: PFDVars.potentiometerFo, type: SimVarValueType.Number },
        ],
        ...
        [
            "alphaProt",
            { name: PFDVars.alphaProt, type: SimVarValueType.Number },
        ],
        ["onGround", { name: PFDVars.onGround, type: SimVarValueType.Number }],
        [
            "activeLateralMode",
            { name: PFDVars.activeLateralMode, type: SimVarValueType.Number },
        ],
        [
            "activeVerticalMode",
            { name: PFDVars.activeVerticalMode, type: SimVarValueType.Number },
        ],
        [
            "fmaModeReversion",
            { name: PFDVars.fmaModeReversion, type: SimVarValueType.Number },
        ],
        [
            "fmaSpeedProtection",
            { name: PFDVars.fmaSpeedProtection, type: SimVarValueType.Number },
        ],
        ["AThrMode", { name: PFDVars.AThrMode, type: SimVarValueType.Number }],
        [
            "apVsSelected",
            { name: PFDVars.apVsSelected, type: SimVarValueType.FPM },
        ],
        [
            "approachCapability",
            { name: PFDVars.approachCapability, type: SimVarValueType.Number },
        ],
        ["ap1Active", { name: PFDVars.ap1Active, type: SimVarValueType.Bool }],
        ["ap2Active", { name: PFDVars.ap2Active, type: SimVarValueType.Bool }],
        [
            "fmaVerticalArmed",
            { name: PFDVars.fmaVerticalArmed, type: SimVarValueType.Number },
        ],
        [
            "fmaLateralArmed",
            { name: PFDVars.fmaLateralArmed, type: SimVarValueType.Number },
        ],
        ["fd1Active", { name: PFDVars.fd1Active, type: SimVarValueType.Bool }],
        ["fd2Active", { name: PFDVars.fd2Active, type: SimVarValueType.Bool }],
        [
            "athrStatus",
            { name: PFDVars.athrStatus, type: SimVarValueType.Number },
        ],
        [
            "athrModeMessage",
            { name: PFDVars.athrModeMessage, type: SimVarValueType.Number },
        ],
        [
            "machPreselVal",
            { name: PFDVars.machPreselVal, type: SimVarValueType.Number },
        ],
        [
            "speedPreselVal",
            { name: PFDVars.speedPreselVal, type: SimVarValueType.Knots },
        ],
        ["mda", { name: PFDVars.mda, type: SimVarValueType.Feet }],
        ["dh", { name: PFDVars.dh, type: SimVarValueType.Feet }],
        [
            "attHdgKnob",
            { name: PFDVars.attHdgKnob, type: SimVarValueType.Enum },
        ],
        ...
        [
            "sideStickX",
            { name: PFDVars.sideStickX, type: SimVarValueType.Number },
        ],
        [
            "sideStickY",
            { name: PFDVars.sideStickY, type: SimVarValueType.Number },
        ],
        [
            "fdYawCommand",
            { name: PFDVars.fdYawCommand, type: SimVarValueType.Number },
        ],
        ...
        [
            "fwcFlightPhase",
            { name: PFDVars.fwcFlightPhase, type: SimVarValueType.Number },
        ],
        [
            "fmgcFlightPhase",
            { name: PFDVars.fmgcFlightPhase, type: SimVarValueType.Enum },
        ],
        ...
        [
            "navRadialError",
            { name: PFDVars.navRadialError, type: SimVarValueType.Degree },
        ],

        [
            "hasGlideslope",
            { name: PFDVars.hasGlideslope, type: SimVarValueType.Bool },
        ],

        [
            "glideSlopeError",
            { name: PFDVars.glideSlopeError, type: SimVarValueType.Degree },
        ],

        [
            "markerBeacon",
            { name: PFDVars.markerBeacon, type: SimVarValueType.Enum },
        ],
        ["vr", { name: PFDVars.vr, type: SimVarValueType.Knots }],
        [
            "isAltManaged",
            { name: PFDVars.isAltManaged, type: SimVarValueType.Bool },
        ],
        [
            "targetSpeedManaged",
            { name: PFDVars.targetSpeedManaged, type: SimVarValueType.Knots },
        ],
        ...
        [
            "flapHandleIndex",
            { name: PFDVars.flapHandleIndex, type: SimVarValueType.Number },
        ],
        [
            "greenDotSpeed",
            { name: PFDVars.greenDotSpeed, type: SimVarValueType.Number },
        ],
        [
            "slatSpeed",
            { name: PFDVars.slatSpeed, type: SimVarValueType.Number },
        ],
        ...
        [
            "transAltAppr",
            { name: PFDVars.transAltAppr, type: SimVarValueType.Number },
        ],
        [
            "groundTrack",
            { name: PFDVars.groundTrack, type: SimVarValueType.Number },
        ],
        [
            "showSelectedHeading",
            { name: PFDVars.showSelectedHeading, type: SimVarValueType.Number },
        ],
        [
            "altConstraint",
            { name: PFDVars.altConstraint, type: SimVarValueType.Feet },
        ],
        [
            "trkFpaActive",
            { name: PFDVars.trkFpaActive, type: SimVarValueType.Bool },
        ],
        ["aoa", { name: PFDVars.aoa, type: SimVarValueType.Degree }],
        [
            "groundHeadingTrue",
            { name: PFDVars.groundHeadingTrue, type: SimVarValueType.Degree },
        ],
        [
            "groundTrackTrue",
            { name: PFDVars.groundTrackTrue, type: SimVarValueType.Degree },
        ],

        [
            "selectedFpa",
            { name: PFDVars.selectedFpa, type: SimVarValueType.Degree },
        ],
        ["vfeNext", { name: PFDVars.vfeNext, type: SimVarValueType.Number }],
        [
            "ilsCourse",
            { name: PFDVars.ilsCourse, type: SimVarValueType.Number },
        ],
        [
            "metricAltToggle",
            { name: PFDVars.metricAltToggle, type: SimVarValueType.Bool },
        ],
        ["tla1", { name: PFDVars.tla1, type: SimVarValueType.Number }],
        ["tla2", { name: PFDVars.tla2, type: SimVarValueType.Number }],
        [
            "landingElevation",
            { name: PFDVars.landingElevation, type: SimVarValueType.Feet },
        ],
        ["tcasState", { name: PFDVars.tcasState, type: SimVarValueType.Enum }],
        [
            "tcasCorrective",
            { name: PFDVars.tcasCorrective, type: SimVarValueType.Bool },
        ],
        [
            "tcasRedZoneL",
            { name: PFDVars.tcasRedZoneL, type: SimVarValueType.Number },
        ],
        [
            "tcasRedZoneH",
            { name: PFDVars.tcasRedZoneH, type: SimVarValueType.Number },
        ],
        [
            "tcasGreenZoneL",
            { name: PFDVars.tcasGreenZoneL, type: SimVarValueType.Number },
        ],
        [
            "tcasGreenZoneH",
            { name: PFDVars.tcasGreenZoneH, type: SimVarValueType.Number },
        ],
        ["tcasFail", { name: PFDVars.tcasFail, type: SimVarValueType.Bool }],

        [
            "engOneRunning",
            { name: PFDVars.engOneRunning, type: SimVarValueType.Bool },
        ],
        [
            "engTwoRunning",
            { name: PFDVars.engTwoRunning, type: SimVarValueType.Bool },
        ],
        [
            "expediteMode",
            { name: PFDVars.expediteMode, type: SimVarValueType.Bool },
        ],
        [
            "setHoldSpeed",
            { name: PFDVars.setHoldSpeed, type: SimVarValueType.Bool },
        ],
        ["vls", { name: PFDVars.vls, type: SimVarValueType.Number }],
        ["alphaLim", { name: PFDVars.alphaLim, type: SimVarValueType.Number }],

        [
            "trkFpaDeselectedTCAS",
            { name: PFDVars.trkFpaDeselectedTCAS, type: SimVarValueType.Bool },
        ],
        [
            "tcasRaInhibited",
            { name: PFDVars.tcasRaInhibited, type: SimVarValueType.Bool },
        ],
        [
            "groundSpeed",
            { name: PFDVars.groundSpeed, type: SimVarValueType.Number },
        ],

        [
            "radioAltitude1",
            { name: PFDVars.radioAltitude1, type: SimVarValueType.Number },
        ],
        [
            "radioAltitude2",
            { name: PFDVars.radioAltitude2, type: SimVarValueType.Number },
        ],

        ["beta", { name: PFDVars.beta, type: SimVarValueType.Degree }],
        [
            "betaTargetActive",
            { name: PFDVars.betaTargetActive, type: SimVarValueType.Number },
        ],

        [
            "betaTarget",
            { name: PFDVars.betaTarget, type: SimVarValueType.Number },
        ],

        ["latAcc", { name: PFDVars.latAcc, type: SimVarValueType.GForce }],
        [
            "crzAltMode",
            { name: PFDVars.crzAltMode, type: SimVarValueType.Bool },
        ],
        [
            "tcasModeDisarmed",
            { name: PFDVars.tcasModeDisarmed, type: SimVarValueType.Bool },
        ],
        ["flexTemp", { name: PFDVars.flexTemp, type: SimVarValueType.Number }],
        [
            "autoBrakeMode",
            { name: PFDVars.autoBrakeMode, type: SimVarValueType.Number },
        ],
        [
            "autoBrakeActive",
            { name: PFDVars.autoBrakeActive, type: SimVarValueType.Bool },
        ],
